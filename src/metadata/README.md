 ...
 * [gcde.yml](gcde.yml)
     * Determines how your purl.obolibrary.org/obo/gcde/ redirects will be handled
     ...
     * Paste in the contents of [gcde.yml](gcde.yml)
 ...
 * [gcde.md](gcde.md)
     ...
     * Paste in the contents of [gcde.md](gcde.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
